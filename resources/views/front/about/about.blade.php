    ...
    <main>
      ...
      <section class="section-container d-flex align-items-center py-4">
        <div class="about__img text-center w-50">
          <img class="w-100" src="{{url('front/assets/images/logo.png')}}" alt="" />
        </div>
        <div class="w-50">
      ...
      <section class="section-container d-flex align-items-center py-5">
        ...
        <div class="about__img text-end w-50">
          <img class="w-100" src="{{url('front/assets/images/about-2.png')}}" alt="" />
        </div>
      </section>
      ...
      <section class="section-container py-5">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="features__item d-flex align-items-center gap-2">
              <div class="features__img">
                <img class="w-100" src="{{url('assets/images/feature-2.png')}}" alt="" />
              </div>
              <div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="features__item d-flex align-items-center gap-2">
              <div class="features__img">
                <img class="w-100" src="{{url('assets/images/feature-3.png')}}" alt="" />
              </div>
              <div>
