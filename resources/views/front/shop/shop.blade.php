            ...
            <div class="products__item col-6 col-md-4 col-lg-3 mb-5">
                ...
                <a href="{{route('front.single.product.index')}}">
                  <div class="product__img-cont">
                    <img
                      ...
                      src="{{url('front/assets/images/product-1.webp')}}"
                      data-id="white"
                    />
                  </div>
                </a>
              ...
              <div class="product__title text-center">
                <a
                  ...
                  href="{{route('front.single.product.index')}}"
                >
                  Flutter Apprentice
                </a>
              </div>
              ...
              <div class="product__header mb-3">
                <a href="{{route('front.single.product.index')}}">
                  <div class="product__img-cont">
                    <img
                      class="product__img w-100 h-100 object-fit-cover"
                      src="{{url('front/assets/images/product-2.webp')}}"
                      data-id="white"
                    />
                  </div>
                </a>
              ...
              <div class="product__header mb-3">
                <a href="{{route('front.single.product.index')}}">
                  <div class="product__img-cont">
                    <img
                      class="product__img w-100 h-100 object-fit-cover"
                      src="{{url('front/assets/images/product-3.webp')}}"
                      data-id="white"
                    />
                  </div>
                </a>
              ...
              <div class="product__header mb-3">
                <a href="{{route('front.single.product.index')}}">
                  <div class="product__img-cont">
                    <img
                      class="product__img w-100 h-100 object-fit-cover"
                      src="{{url('front/assets/images/product-4.webp')}}"
                      data-id="white"
                    />
                  </div>
                </a>
              ...
              <div class="product__header mb-3">
                <a href="{{route('front.single.product.index')}}">
                  <div class="product__img-cont">
                    <img
                      class="product__img w-100 h-100 object-fit-cover"
                      src="{{url('front/assets/images/product-5.webp')}}"
                      data-id="white"
                    />
                  </div>
                </a>
