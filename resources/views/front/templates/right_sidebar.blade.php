      <div class="nav__categories offcanvas offcanvas-start px-4 py-2" tabindex="-1" id="nav__categories"
        ...
        <div class="nav__categories-body offcanvas-body pt-0">
          ...
          <ul class="nav__list list-unstyled">
            <li class="nav__link nav__side-link"><a href="{{route('front.shop.index')}}" class="py-3">جميع المنتجات</a></li>
            <li class="nav__link nav__side-link"><a href="{{route('front.shop.index')}}" class="py-3">كتب عربيه</a></li>
            <li class="nav__link nav__side-link"><a href="{{route('front.shop.index')}}" class="py-3">كتب انجليزية</a></li>
          </ul>
        </div>
      </div>